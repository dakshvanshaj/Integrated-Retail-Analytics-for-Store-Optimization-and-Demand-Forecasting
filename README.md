...
- Initialized project skeleton using uv init and created a venv with 3.13.7 python version.
- use - uv sync to install project dependencies and uv add to add project dependencies.
